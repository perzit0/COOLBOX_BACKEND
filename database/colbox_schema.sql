...
-- ---------------------------------------------------------------------
-- Usuario Administrador semilla (para poder iniciar sesión desde cero)
-- Correo: admin@coolbox.com   |   Clave: Admin123
-- ---------------------------------------------------------------------
INSERT INTO "Usuario" ("Nombres", "ApellidoPaterno", "Email", "Password") VALUES
    ('Admin', 'COLBOX', 'admin@coolbox.com',
     'scrypt:32768:8:1$mAJPJ3bwjEkXRzep$d63ed8596076735465343954a77e6e25e2c3c840038c2dbeae22557f61b3150790a21991cd8ddd9156d8fb492b4aaa38f33028d3a2e2517efbb93705fd5a0e53')
ON CONFLICT DO NOTHING;

INSERT INTO "Usuario_Perfiles" ("IdUsuario", "IdPerfil")
SELECT u."IdUsuario", p."IdPerfil"
FROM "Usuario" u, "Perfiles" p
WHERE u."Email" = 'admin@coolbox.com' AND p."Nombre" = 'Administrador'
ON CONFLICT DO NOTHING;
